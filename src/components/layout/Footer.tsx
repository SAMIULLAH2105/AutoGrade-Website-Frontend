...
import { FileCheck, Mail, Twitter, Github, Linkedin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground max-w-xs">
              AI-powered O & A Level paper checking platform. Get instant, accurate feedback on your exam papers.
            </p>
